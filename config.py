...
EVALOP = list(map(int, getenv("EVALOP", "7491834397").split()))
...
LOGGER_ID = int(getenv("LOGGER_ID", "-1002454015353"))
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/c6a414ba785b10817ceba-16f3cccf3fdfcf246b.jpg"
)
PING_IMG_URL = getenv(
